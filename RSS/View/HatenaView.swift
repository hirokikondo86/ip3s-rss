...
class HatenaViewModel: ObservableObject {
    @Published var items: [Item] = []
    @Published var topic: String = "home"

    init() {
        let urlString = "https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fb.hatena.ne.jp%2Fentrylist%2Fit.rss"
...
struct HatenaArticleListView: View {
